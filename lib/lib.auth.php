...
class Auth {
    ...
    public function login($username, $password) {
        ...
        $res = $db->query("SELECT * FROM user WHERE username = " . $db->quote($username) . " AND password = " . $db->quote($hashed_password));
...
//            }
    ...
    private function attemptCookieLogin() {
        ...
        $res = $db->query('SELECT * FROM user WHERE nid = ' . $db->quote($nid));

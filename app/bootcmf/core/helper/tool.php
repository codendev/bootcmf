...
class Core_Helper_Tool{
	...
	public static function  download_document($filename, $mimetype = 'application/octet-stream') {
	...
	public static function  limitString($string, $limit = LIMIT_STRING) {
	...
	public static function  str_replace_word($filters,$haystack) {
	...
	public static function  strExistWord($filters,$haystack) {
		foreach($filters as $needle) {
			$pattern = "/\b$needle\b/i";
	...
	public static function  sendMail($htmlmsg='',$txtmsg='',$to=array(),$subject=null,$reply_to=null) {

...
class Core_Helper_Template{
	
	public static function template($path,$data=array(),$value=FALSE) {
	...
	public static function paging( $total_pages, $current_page, $page_link, $page_number,$path) {
